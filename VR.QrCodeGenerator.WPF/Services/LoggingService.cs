...
namespace VR.QrCodeGenerator.WPF.Services
{
    public static class LoggingService
    {
        ...
        private static void Info(string message, [CallerMemberName] string callerMemberName = "", [CallerLineNumber] int callerLineNumber = -1, [CallerFilePath] string callerFilePath = "")
        {
            PushPropertiesAndLog(callerMemberName, callerLineNumber, callerFilePath, () => Log.Information(message));
        }

        public static void Warn(string message, [CallerMemberName] string callerMemberName = "", [CallerLineNumber] int callerLineNumber = -1, [CallerFilePath] string callerFilePath = "")
        {
            PushPropertiesAndLog(callerMemberName, callerLineNumber, callerFilePath, () => Log.Warning(message));
        }

        public static void Error(string message, Exception exception = null, [CallerMemberName] string callerMemberName = "", [CallerLineNumber] int callerLineNumber = -1, [CallerFilePath] string callerFilePath = "")
        {
